...
fun LOOK(navController: NavController, state:State, viewModel: SaathiViewModel) {
    ...
    Scaffold(
        ...
        {
            DESCDisplay(interactionSource,state, viewModel = viewModel,controller)
...
@Composable
fun DESCDisplay(interactionSource: MutableInteractionSource,state: State,viewModel: SaathiViewModel,controller:LifecycleCameraController)
{
